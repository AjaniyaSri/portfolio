...
import storeSalesdashboard from "../assets/projects/dashboard-preview.jpg";
...
export const projects = [
  ...
  },
  {
    ...
    year: "2026",
    image: storeSalesdashboard,
    points: [
      "Performed comprehensive analysis of Superstore sales data to uncover trends, regional performance, and profit-driving categories.",
      "Built and deployed a machine learning regression model to predict sales using key business factors such as discounts, product categories, and regions.",
      "Created an interactive Power BI dashboard featuring KPIs, category and sub-category insights, discount impact analysis, and geographic sales distribution.",
    ],
